...
export function ConsoleTile({ consoleDef, games, config, onOpen }: ConsoleTileProps): JSX.Element {
  return (
    ...
    >
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_18%_20%,rgba(255,255,255,0.34),transparent_28%),linear-gradient(180deg,rgba(0,0,0,0.04),rgba(0,0,0,0.42))]" />
      <div className="relative flex h-full flex-col justify-between">
        <div className="flex items-start justify-between gap-4">
          ...
          <div className="rounded-lg border border-white/18 bg-black/18 p-3 backdrop-blur-md">
